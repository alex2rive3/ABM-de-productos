...
// Si no está logueado e intenta ingresar a esta página por medio de la URL, será redirigido al login directamente
if (!isset($_SESSION['id']) || empty($_SESSION['id'])) {
    header("Location: f_login.php");
    exit; // Agregamos exit para detener la ejecución del script después de redirigir.
}

// Cuando se realiza una consulta, se carga los datos en $ResultadoConsulta para poder ponerlos en los input y editarlos
if ($_POST) {
...
<head>
    ...
    <script src="libs/funciones.js" defer></script>
    <title>Inicio</title>
</head>
<body>
            ...
            <form action="registrar.php" method="post" class="contenedor" id="formulario">
                ...
                <div class="seccion">
                    <fieldset>
                        ...
                        <select name="seccion" id="seccion" class="seleccion" required>
                            <?php
                            //cuando se realiza la consulta el array tendrá un id y gracias a eso se cargará la opción ya traída de la base de datos 
                            if ($ResultadoConsulta['id']) {
                                echo '<option selected value="' . $ResultadoConsulta['seccion'] . '">' . $ResultadoConsulta['seccion'] . '</option>';
                            } else {
                                ?>
                                <!--En caso contrario estará seleccionada la opción de elegir opción-->
                            ...
                            //se iteran todas las filas y se mandan a option para ser visualizadas
                ...
                <div class="iva">
                    <fieldset>
                        ...
                        ?>"><?php echo $ResultadoConsulta['iva']; ?></option>
                        </fieldset>
                    </div>
                    <!--//////////////////////RECARGO%////////////////////////////////-->
                    <div class="recargo">
                    ...
                    <!--/////////////////////BOTONES//////////////-->
                    <div class="registrar">
                        <!--El botón se deshabilita cuando se realiza una consulta-->
